<template>
<modal name="edit-task" transition="pop-out" :width="modalWidth" :height="650" @before-open="beforeOpen" @before-close="beforeClose">
  <div class="box">

      <div class="partition" id="partition-register">
        <div class="partition-title">Edit Todo</div>
        <div class="partition-form">
          ...
          <button class="large-btn edit-btn" @click="isEmpty(uid, title, desc, priority, myDate)">Edit <span>Todo</span></button>
          <button class="large-btn cancel-btn" @click="$modal.hide('edit-task');">Cancel</button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    beforeOpen() {
      ...
      this.desc = event.params.desc;
      this.priority = event.params.priority;
      this.myDate = moment(event.params.myDate, 'D MMM YYYY').format('YYYY-MM-DD');
    },
    beforeClose () {
      // initialize
      this.title = '';
    ...
    isEmpty(uid, title, desc, priority, myDate) {
